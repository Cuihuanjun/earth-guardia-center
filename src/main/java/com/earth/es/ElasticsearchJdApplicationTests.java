...
public class ElasticsearchJdApplicationTests {
    ...
    void testUpdateRequest() throws IOException {
        ...
        User user = new User(null,"狂神说Java", "18");
    ...
    void testBulkRequest() throws IOException {
        ...
        userList.add(new User(null,"kuangshen1", "3"));
        userList.add(new User(null,"kuangshen2", "3"));
        userList.add(new User(null,"kuangshen3", "3"));
        userList.add(new User(null,"qinjiang1", "3"));
        userList.add(new User(null,"qinjiang2", "3"));
        userList.add(new User(null,"qinjiang3", "3"));
        // 批处理请求
